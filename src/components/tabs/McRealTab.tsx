...
export function McRealTab() {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header: tabs + sort */}
      <div
        className={`flex border-b backdrop-blur-md z-10 ${isMobile ? "flex-wrap items-center gap-2 px-3 py-2" : "items-center gap-2 px-6 py-3"}`}
      ...
      >
        ...
        <select
          ...
          className={`bg-black/40 border border-white/20 rounded-md text-white font-minecraft-ten text-[11px] px-1.5 py-1.5 outline-none cursor-pointer${isMobile ? " flex-1 min-w-0" : ""}`}
        >
          {SORTS.map((s) => (
